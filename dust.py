...
def banner():
	clear()
	au=f"""
  [white].___                 __   [•] Author : [green]Tenking-XD x NazriXD[white]
  |   | ____   _______/  |______  [•] Github.com : [green]Tenking-XD[white]
  |   |/    \ /  ___/\   __\__  \ [•] Setatus : [green]Premium[white]
  |   |   |  \\___ \  |  |  / __ \_
  |___|___|  /____  >|__| (____  /   [red] █████████████████████[white]
           \/     \/            \/   [white] █████████████████████ 
"""
...
def Aku_cantik():
    if "sukses" in lisensiku:
        try:
            ...
            sol().print(wel2)
            cetak(nel(f'>> 1. Login Menggunakan Cookies\n>> 2. Login Menggunakan Username & Paswoard'))
...
class instagram:
    ...
    def logo(self):
        for i in external:
            ...
            print(f"\t╭──────────────────────╮   ╭──────────────────────╮")
            print(f"\t│    Followers : {H}{followers}{N}    │   │    Following : {H}{following}{N}   │")
            print(f"\t╰──────────────────────╯   ╰──────────────────────╯")
            print("  ╭────────────────────────────────────────────────────────────╮")
            print(f"  │ {P}[{H}01{P}] crack dari pencarian{N}     {P}[{H}02{P}] crack dari pengikut{N}     │\n  │ {P}[{H}03{P}] crack dari mengikuti{N}     {P}[{H}04{P}] crack kembali akun cp{N}   │\n  │ {P}[{H}05{P}] cek hasil crack{N}          {P}[{H}06{P}] bot auto follow{N}         │\n  │ {P}[{H}Ee{P}] {M}Logout{N}                                                │")
            print(f"╭─╰────────────────────────────────────────────────────────────╯")
...
def mengecek_():
    try:
           ...
           cek = open ("Data/lisensi.txt","r").read()
    ...
    if os.path.exists('Data/lisensi.txt'):
           try:
                   cek = open('Data/lisensi.txt', 'r').read()
                   lis = requests.get("https://github.com/Tenking-XD/ig-prem/blob/main/kuy.txt").text.strip()
                   if cek in lis:
                          os.system('clear');banner()
                          jalan(' %s[%s✓%s] Lisensi kamu sudah aktif √'%(N,H,N));jeda(2);Aku_cantik()
                   else:
                          os.system('clear');banner()
                          jalan(' %s[%s×%s] Licensi kamu tidak aktif'%(N,M,N));jeda(2);os.system('rm -rf Data/lisensi.txt');konfirmasi()
           except IOError:
                   konfirmasi()
    else:
           konfirmasi()
